...
public class SetMiddleware_FTPParam extends BaseParam{

    private String enable;

    private String limit_speed;//限制速度 单位 KB

    private String search_filter;//过滤该日期之前的文件不上传，日期格式，2014-01-01

    private String filter_enable;//是否启用过滤日期 0|1
    ...
    private String deviceid;//设备 id 标识

    private String svrusr ;//服务器用户名

    private String svrpwd ;//服务器密码

    private String pasvmode ;//是否为被动模式 0|1
