...
public class JacksonUtil {
	...
	public static String objebtToString(Object object){
		...
		ObjectMapper mapper = new ObjectMapper();
		 try {
				...
				LogUtil.intoLog(JacksonUtil.class,json+":json");
				return json;
			} catch (Exception e) {
				e.printStackTrace();
			}
	...
	public static List stringToObjebt_2(String json,Object t ){
		...
		try {
			...
			LogUtil.intoLog(1,JacksonUtil.class,"stringToObjebt_1转换出错json："+json);
	...
	public static Object stringToObjebt_2(Object obj,Class cclass ){
		...
		ObjectMapper mapper = new ObjectMapper();
		 try {
			 ...
			 LogUtil.intoLog(1,JacksonUtil.class,"stringToObjebt_2转换出错json："+obj);
			}
		 return null;
	}
	 ...
	 * @return
	 */
	public static Object objtoobj(Object out,Object in){
		try {
			Gson gson = new Gson();
			out=gson.fromJson(gson.toJson(in),out.getClass());
			return out;
		} catch (Exception e) {
			e.printStackTrace();
		}
